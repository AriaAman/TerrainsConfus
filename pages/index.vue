  ...
  meta: [
    {
      name: 'description',
      content:
        'Terrain Confus offre des solutions personnalisées pour la transformation et l’aménagement de votre espace extérieur. Découvrez nos services et notre expertise en quelques clics.',
    },
...
useSeoMeta({
  title:
    'Terrain Confus - Aménagez votre extérieur avec créativité et expertise',
  ogTitle: 'Aménagement de Terrain Sur Mesure | Terrain Confus',
  description:
    'Réalisez l’aménagement de votre terrain avec Terrain Confus. Nous combinons créativité et expertise technique pour transformer votre espace extérieur selon vos souhaits.',
  ogDescription:
    'Spécialiste de l’aménagement de terrain, Terrain Confus vous accompagne dans la conception d’un espace extérieur unique et sur mesure. Commencez votre projet avec nous dès aujourdhui !',
...
<template>
  <div>
    ...
    <!--  Import de la partie contact -->
    <accueil-contact data-aos="fade-right" id="contact"></accueil-contact>
  </div>
</template>
...
/*Début de la partie logosociaux*/
.logosociaux {
  position: absolute;
  bottom: 15px;
  left: 60px;
